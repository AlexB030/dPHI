...
% between s and M for the PHI and dPHI protocol.
%
clc
clear all
%close all
...
for(currExperiment=1:numOfExperiments)
    ...
    [treeToM distanceToM] = shortestAllBGPtreeDestination(listOfNodes,sourceCellC,sourceCellP,sourceCellPtoP,helperNode);
...
if(useIPrange)
    save('sourceAnonymityStoMforstored1000IP.mat','anonymitySetsizePHIAll','anonymitySetsizeDPHIAll','anonymityComparisonAll','anonymitySetsizePHIAllSingle','anonymitySetsizeDPHIAllSingle','anonymityComparisonAllSingle')
else
    save('sourceAnonymityStoMforstored1000NoIP.mat','anonymitySetsizePHIAll','anonymitySetsizeDPHIAll','anonymityComparisonAll','anonymitySetsizePHIAllSingle','anonymitySetsizeDPHIAllSingle','anonymityComparisonAllSingle')
end
